...
Three-body (23) & 0.480 & 0.860 & +0.380 & Eq.~\ref{eq:discovered} \\
\bottomrule
\end{tabular}
\end{table}
...
are close (Breast Cancer: gap $= 1.4\%$), and problems that fundamentally
require complex models (Three-body: gap $= 38\%$).
