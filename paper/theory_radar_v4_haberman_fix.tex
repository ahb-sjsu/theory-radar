...
through a single PLS component ($\mathrm{pls}_0$) that combines all
...
indirection is minimal: $\mathrm{pls}_0$ is a single weighted sum of the three raw features, making the full model a linear threshold.  The
